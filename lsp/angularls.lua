...
return {
    cmd = {
        ...
        '--stdio',
        '--tsProbeLocations',
        vim.fn.expand '~/AppData/Local/nvim-data/mason/packages/angular-language-server/node_modules/typescript/lib',
        '--ngProbeLocations',
        vim.fn.expand '~/AppData/Local/nvim-data/mason/packages/angular-language-server/node_modules/@angular/language-server/node_modules',
        '--angularCoreVersion',
